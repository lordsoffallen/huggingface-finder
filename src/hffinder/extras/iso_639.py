# https://github.com/huggingface/huggingface.js/blob/main/packages/languages/src/languages_iso_639_1.ts
LANGUAGES_ISO_639_1 = {
    "aa": {
        "code": "aa",
        "name": "Afar"
...
# https://github.com/huggingface/huggingface.js/blob/main/packages/languages/src/languages_iso_639_3.ts
LANGUAGES_ISO_639_3 = {
    "aaa": {
        "code": "aaa",
        "name": "Ghotuo"
